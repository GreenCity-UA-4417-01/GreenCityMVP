...
public class EcoNewsController {
    ...
    @ResponseStatus(value = HttpStatus.CREATED)
    @ApiResponses(value = {
            @ApiResponse(responseCode = "201", description = HttpStatuses.CREATED, content = @Content(schema = @Schema(type = "string", example = "/img/eco-news/image1.jpg"))),
    ...
    @ApiResponses(value = {
            ...
            @ApiResponse(responseCode = "400", description = "Bad Request")  // додано 400 код
    })
    @GetMapping("/tags/all")
    @ApiLocale
